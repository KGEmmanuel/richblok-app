...
@Component({
  selector: 'app-post-identify',
  templateUrl: './post-identify.component.html',
  styleUrls: ['./post-identify.component.scss']
})
export class PostIdentifyComponent implements OnInit {
  public model: any;
  constructor() { }
