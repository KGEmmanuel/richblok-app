...
@Component({
  selector: 'app-friend-suggestion-item',
  templateUrl: './friend-suggestion-item.component.html',
  styleUrls: ['./friend-suggestion-item.component.scss']
})
export class FriendSuggestionItemComponent implements OnInit {
