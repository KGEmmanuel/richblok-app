...
@Component({
  selector: 'app-friend-invitation-item',
  templateUrl: './friend-invitation-item.component.html',
  styleUrls: ['./friend-invitation-item.component.scss']
})
export class FriendInvitationItemComponent implements OnInit {
